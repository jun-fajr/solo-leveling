...
if __name__ == "__main__":
    try:
        # Membaca input pertama berupa N dan M
        N, M = map(int, input("Masukkan N dan M: ").split())
        
        # Membaca array Ai (tingkat kemahiran lawan)
        Ai = list(map(int, input("Masukkan Ai (tingkat kemahiran lawan): ").split()))
        
        # Membaca array Bi (penambahan kemahiran setelah mengalahkan lawan)
        Bi = list(map(int, input("Masukkan Bi (penambahan kemahiran setelah menang): ").split()))
